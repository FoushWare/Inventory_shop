...
public class ItemProvider extends ContentProvider {
   ...
   /*uri code that returned when shooting specific uri [content://com.example.tom.inventoryshop]*/
    ...
    private Uri InsertItem(Uri uri, ContentValues values) {
        ...
        //put some checks and defaults  for inserting item
        if (values.getAsString(ItemEntry.Column_Item_name).isEmpty()) {
            values.put(ItemEntry.Column_Item_name, "unknown item");
        }
